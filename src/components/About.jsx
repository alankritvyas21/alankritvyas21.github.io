  ...
  return (
    <>
      ...
      <div className="about__container container grid">
        <img data-aos="fade-right" data-aos-delay="300" src={AboutImg} alt="about" className="about__img" />

        <div className="about__data">
          <div className="about__info grid" data-aos="fade-left" data-aos-delay="300">
          ...
          <p className="about__description" data-aos="fade-up" data-aos-delay="300">
            ...
            design and technical problems. I am committed to providing top-notch
            outcomes, whether I am working on large-scale projects or creating
            tiny, dynamic sites.
          </p>
          <div className="about__download">
            <button className="button button--flex" id="downloadBtn" data-aos="fade-up" data-aos-delay="300">
              <span className="button__text" onClick={startFileDownload}>Download CV</span>
